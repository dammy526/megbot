...
// =======================================
console.log("🔧 環境變數檢查:");
console.log("DISCORD_BOT_TOKEN:", process.env.DISCORD_BOT_TOKEN ? "✅ 已設定" : "❌ 未設定");
console.log("ADMIN_ROLE_ID:", process.env.ADMIN_ROLE_ID || "未設定");
console.log("API_KEY:", process.env.API_KEY ? "✅ 已設定" : "未設定");
console.log("WEBSITE_API:", process.env.WEBSITE_API || "未設定");

// 檢查必要的環境變數
if (!process.env.DISCORD_BOT_TOKEN) {
  console.error('❌ 錯誤: DISCORD_BOT_TOKEN 環境變數未設定');
  console.error('💡 請在 Railway 的 Variables 中設定 DISCORD_BOT_TOKEN');
  process.exit(1);
}

console.log("✅ 環境檢查通過，啟動 Bot...");
